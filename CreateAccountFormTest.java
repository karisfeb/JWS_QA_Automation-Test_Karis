...
public class CreateAccountFormTest {
	...
	public void authenticationPageEmailField() {
		...
		// Wrong email format (testAtgmail.com, testaja@gmailcom, testaja@gmail, @gmail ...)
		createAccount.setCreateAccountEmailField("Tole");
		createAccount.getCreateAccountBtn().click();
		...
		// Correct email
		createAccount.setCreateAccountEmailField("testaja@gmail.com");
		createAccount.getCreateAccountBtn().click();
	...
	public void personalInfoFields() {
		...
		createAccountForm.setCustomerLastNameField("aja");
		createAccountForm.setCustomerEmailField("testaja@gmailcom");
	...
	public void requiredFieldsEmpty() {
		...
		createAccountForm.selectCountry("Indonesia");
		createAccountForm.getRegisterBtn().click();
	...
	public void requiredFieldsInputFormat() throws Exception {
		// Wrong format
		createAccountForm.setCustomerEmailField("testaja@gmail");
		createAccountForm.setCustomerPasswordField("tester123");
		...
		// Correct format
		createAccountForm.setCustomerEmailField("email@gmail.com");
		createAccountForm.setCustomerPasswordField("tester123");
		createAccountForm.setPostalCodeField("12345");
		createAccountForm.setHomePhoneField("062");
	...
	public void createAccountSuccessfully() {
		...
		createAccountForm.setCustomerFirstNameField("Inem");
		createAccountForm.setCustomerLastNameField("Tole");
		createAccountForm.setCustomerPasswordField("tester123");
		...
		createAccountForm.setAddressField("Tebet");
		createAccountForm.setCityField("Gak jls");
		createAccountForm.selectState("8");
		createAccountForm.setPostalCodeField("21000");
		createAccountForm.setHomePhoneField("062");
		createAccountForm.setMobilePhoneField("064");
